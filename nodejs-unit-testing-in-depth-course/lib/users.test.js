...
describe('users', () => {
  ...
  context('reset password', () => {
    let resetPassMailStub;

    beforeEach(() => {
      resetPassMailStub = sandbox.stub(mailer, 'sendPasswordResetEmail').resolves('reset');
    });
    ...
    it('should call sendPasswordResetEmail', async() => {
      ...
      expect(resetPassMailStub).to.have.been.calledWith('foo@bar.com');
    })
  });
});